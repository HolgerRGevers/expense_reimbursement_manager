...
| Head of Dept | Expense_Claim | Pending HoD claims + all | Stage 2 | Final authority |
...
| Field | Employee | Line Manager | HoD | Finance/Admin |
|-------|----------|-------------|-----|---------------|
| Status | Read-only | Read-only | Read-only | Editable |
| GL_Code | Hidden | Read-only | Read-only | Editable |
| Rejection_Reason | Read-only | Editable | Editable | Editable |
| Amount | Editable (on create) | Read-only | Read-only | Read-only |
| Department_Shadow | Hidden | Hidden | Hidden | Hidden (private) |
| Client_Shadow | Hidden | Hidden | Hidden | Hidden (private) |
| Parent_Claim_ID | Hidden | Hidden | Hidden | Hidden (private) |
